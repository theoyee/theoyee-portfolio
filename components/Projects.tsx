...
export default function Projects() {
  ...
  return (
    <section ref={sectionRef} className="w-full px-2 py-6">
      <div className="w-full rounded-[28px] border border-white/[0.06] bg-[#0D0F0D] p-10 sm:p-12">
        <div className="flex items-start justify-between gap-6">
          <div>
            <h2 className="text-[#E7E5DE] text-xl font-display font-semibold leading-tight">Projects</h2>
            <p className="text-white/45 text-sm mt-1">Selected work</p>
          </div>
        ...
        <h3 className="proj-headline mt-10 text-[#E7E5DE] text-4xl sm:text-5xl md:text-[52px] font-display font-semibold leading-[1.08] tracking-tight max-w-2xl">
          Things I{`'`}ve built and shipped.
        </h3>
        <p className="proj-desc mt-6 text-white/50 text-base sm:text-lg leading-relaxed max-w-2xl font-sans">
          Each one solved a real constraint — real-time data, recommendation quality, render
          throughput. No todo apps.
        </p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-white/[0.06] pt-10">
          <Link
            href="https://zentra-degen.vercel.app/"
            target="_blank"
            className="proj-card group rounded-2xl border border-white/[0.06] bg-[#101210] overflow-hidden hover:border-[#FFB000]/25 transition-colors flex flex-col">
            <div className="relative h-52 bg-[#0c0c0d] overflow-hidden">
              <div
                className="absolute inset-0 opacity-40"
                style={{
                  backgroundImage:
                    "linear-gradient(rgba(255,176,0,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(255,176,0,0.15) 1px, transparent 1px)",
                  backgroundSize: "24px 24px",
                }}
              />
              <svg viewBox="0 0 400 120" className="absolute bottom-0 left-0 w-full h-24 opacity-80" preserveAspectRatio="none">
              ...
              <div className="absolute top-4 left-4 flex items-center gap-1.5 rounded-full bg-black/60 border border-white/10 px-2.5 py-1">
                <span className="h-1.5 w-1.5 rounded-full bg-[#59D9C7] animate-pulse" />
                <span className="text-[10px] font-mono uppercase tracking-wider text-white/70">live</span>
              </div>
              <div className="absolute bottom-4 right-4 font-mono text-[11px] text-[#FFB000]/70">$DEGEN +182.4%</div>
            </div>

            <div className="p-6 flex flex-col flex-1">
              <div className="proj-card-meta flex items-start justify-between gap-3">
                <h4 className="text-[#E7E5DE] text-xl font-semibold">Zentra Degen Scanner</h4>
                <ArrowUpRight className="h-5 w-5 text-white/30 group-hover:text-[#FFB000] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shrink-0" />
              </div>
              <p className="proj-card-meta mt-2 text-white/50 text-sm leading-relaxed flex-1 font-sans">
                A Bloomberg-terminal-style scanner for Solana meme coins — live ticker feed, risk
                scoring, and a token detail view built for split-second reads.
              </p>
              <div className="mt-5 flex flex-wrap gap-2">
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1">
              <div className="proj-card-meta flex items-start justify-between gap-3">
                <h4 className="text-[#E7E5DE] text-xl font-semibold">Reelwise</h4>
                <ArrowUpRight className="h-5 w-5 text-white/30 group-hover:text-[#FFB000] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shrink-0" />
              </div>
              <p className="proj-card-meta mt-2 text-white/50 text-sm leading-relaxed flex-1 font-sans">
                An AI movie recommendation app with taste-modeling that actually improves with
        ...
        <div className="proj-directory mt-6 border-t border-white/[0.06]">
          {secondary.map((p, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  <h4 className="text-[#E7E5DE] text-lg font-medium">{p.title}</h4>
                  <span
                    className={`flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded-full border ${p.status === "live"
                      ? "text-[#59D9C7] border-[#59D9C7]/30 bg-[#59D9C7]/10"
                      : "text-white/40 border-white/10"
                      }`}
                  >
                    <Gauge className="h-3 w-3" />
                ...
                <p className="mt-1.5 text-white/45 text-sm leading-relaxed max-w-xl font-sans">{p.desc}</p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {p.tags.map((tag, j) => (
                    <span key={j} className="text-[11px] font-mono uppercase tracking-wider text-white/35 border border-white/[0.08] rounded-full px-2.5 py-1">
                      {tag}
              ...
              <span className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/30 group-hover:text-[#08090A] group-hover:border-[#FFB000] group-hover:bg-[#FFB000] transition-colors shrink-0 self-start sm:self-center">
                <ArrowUpRight className="h-4 w-4" />
              </span>
            </Link>
          ))}
        ...
        <div className="proj-cta mt-10 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link
            href="https://github.com/theoyee"
            target="_blank"
            className="group max-sm:mx-auto flex items-center gap-3 rounded-full bg-white/[0.08] pl-6 pr-2 py-2 text-white font-medium hover:bg-[#FFB000] hover:text-[#08090A] transition-colors self-start sm:self-auto focus:outline-none focus-visible:ring-2 focus-visible:ring-[#59D9C7] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0F0D]"
          >
            <span>View GitHub</span>
            <span className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 bg-[#151516] group-hover:bg-[#08090A] group-hover:border-black/20 group-hover:text-[#FFB000] transition-colors">
              <ArrowUpRight className="h-4 w-4" />
            </span>
          </Link>
        </div >
