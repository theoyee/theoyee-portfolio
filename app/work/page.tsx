...
const WORK_HISTORY = [
  ...
  },
  {
    ...
    location: "Remote",
    url: "https://campus-frontend-three.vercel.app/",
  ...
  },
  {
    ...
    period: "2024",
    location: "Remote",
    url: "https://defi-stress-app.vercel.app/",
    desc: "Built a decentralized finance application focused on exploring and visualizing DeFi stress scenarios.",
    highlights: [
      "Developed responsive frontend interfaces and interactive application flows",
      "Integrated blockchain-focused application logic and data handling",
    ],
    tags: ["React", "DeFi", "Web3"],
  },
  {
    company: "GTA VI",
    logo: "GTA",
    ...
    period: "2024",
    location: "Remote",
    url: "https://gtavi-psi.vercel.app/",
    desc: "Built an immersive GTA VI-inspired web experience with a strong focus on visual presentation and interaction.",
    highlights: [
      "Created a visually engaging landing experience with responsive layouts",
      "Implemented interactive frontend experiences with modern animation techniques",
    ],
  ...
  },
  {
    ...
    period: "2024",
    location: "Remote",
    url: "https://call-of-duty-kappa.vercel.app/",
    desc: "Designed and developed a Call of Duty-inspired frontend experience focused on immersive visual interactions.",
    highlights: [
      "Built a responsive gaming-themed interface with strong visual hierarchy",
      "Implemented interactive UI elements and polished frontend experiences",
    ],
...
export default function Work() {
  ...
  const visibleWork = showMore
    ? WORK_HISTORY
    : WORK_HISTORY.slice(0, 7);
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.set(rootRef.current, { autoAlpha: 1 })
        ...
        .from(
          ".work-stat",
          { y: 16, autoAlpha: 0, stagger: 0.09, duration: 0.5 },
          "-=0.3"
        );
    ...
    >
      ...
      <main className="min-h-full w-full max-w-[85rem] items-center justify-between py-6 sm:items-start relative" >
        <div className="section-wrapper">
            ...
            <div className="w-full rounded-[32px] border border-white/[0.08] bg-[#0A0B0A] p-10 sm:p-12 relative overflow-hidden">
              ...
              <h1 className="relative mt-8 text-[#E7E5DE] text-4xl sm:text-5xl md:text-[52px] font-display font-semibold leading-[1.08] tracking-tight max-w-2xl">
                {words.map((w, i) => (
                  <span
                    key={i}
                    className="inline-block overflow-hidden align-top mr-[0.28em] pb-1"
                  >
              ...
              <div className="relative mt-10 grid grid-cols-3 gap-4 sm:gap-8 max-w-lg border-t border-white/[0.06] pt-8">
                {STATS.map((stat, i) => (
                  <div key={i} className="work-stat">
                    ...
                    <p className="mt-1 text-white/35 text-xs sm:text-sm">
                      {stat.label}
                    </p>
                  </div>
                ))}
          ...
          <section className="w-full md:px-2 py-6">
            <div className="work-timeline relative w-full rounded-[28px] md:bg-[#0D0F0D] md:border md:border-white/[0.06] py-10 sm:py-12 px-4 sm:px-12 overflow-hidden">
              <svg
              ...
              <div
                ...
                style={{
                  top: "0%",
                  boxShadow: "0 0 10px 2px rgba(89,217,199,0.6)",
                }}
              />
              ...
              <div className="flex flex-col gap-10 sm:gap-14">
                {visibleWork.map((job, i) => {
                  ...
                  return (
                    <div
                      key={job.company}
                      className="work-card relative flex gap-6 sm:gap-10"
                    >
                      ...
                      <div className="work-card-inner group flex-1 rounded-2xl border border-white/[0.07] bg-[#101210] p-6 sm:p-8 transition-colors hover:border-[#FFB000]/25 relative">
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-3">
                          <div>
                            ...
                            <p className="mt-1 text-white/55 text-sm font-medium">
                              {job.company}
                            </p>
                          </div>
                        ...
                        <ul className="mt-5 flex flex-col gap-2">
                          {job.highlights.map((h, j) => (
                            ...
                            >
                              <span className="mt-0.5 font-mono text-[#FFB000]/70 shrink-0">
                                {">"}
                              </span>
                        ...
                        {job.url && (
                          <a
                            ...
                            className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#59D9C7]/25 bg-[#59D9C7]/[0.06] px-4 py-2 text-[11px] font-mono uppercase tracking-widest text-[#59D9C7] transition-colors hover:border-[#59D9C7]/60 hover:bg-[#59D9C7]/[0.12]"
                          >
              ...
              {!showMore && (
                <div className="mt-12 flex justify-center">
                  <button
                    ...
                    className="group flex items-center gap-3 rounded-full border border-[#FFB000]/30 bg-[#FFB000]/[0.06] px-6 py-3 text-[#FFB000] font-mono text-xs uppercase tracking-widest transition-colors hover:border-[#FFB000]/70 hover:bg-[#FFB000]/[0.12]"
                  >
